      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form_container">
            ...
            <form action="add_fournisseur_action.php" method="post" enctype="multipart/form-data" >
              <div>
                <input type="text" name="nom" placeholder="First Name"required />
              </div>
              <div>
                <input type="text" name="pre" placeholder="Last Name " required/>
              </div>
              <div>
              ...
              <div>
                <input type="number" name="ida" placeholder="Id Admin">
              </div>
              <!--value= $_SESSION['id']?>-->
              <table>
                <tr>
